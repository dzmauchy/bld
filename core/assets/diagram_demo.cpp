...
extern "C" void mount() {
  ...
  auto gpio_in_0_pins = Array<u8>{};
  gpio_in_0_pins.push_back(0);
  gpio_in_0_pins.push_back(1);
  gpio_in_0_pins.push_back(4);
  ...
  gpio_in_0->apply();
  auto gpio_in_0_hw = Array<u8>{};
  gpio_in_0_hw.push_back(0);
  gpio_in_0_hw.push_back(1);
  gpio_in_0_hw.push_back(4);
  register_gpio_block(4u, 0, gpio_in_0_hw);
  auto cos_gen_f32_0_dn = VectorizedInput<Pss<F32>>{};
  cos_gen_f32_0_dn.push_back(scope_f32_0_in[0]);
