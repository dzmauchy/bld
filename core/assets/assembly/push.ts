...
function pushAll(streams: Vector<F32PushStream>, value: f32): void {
...
export class ProductF32 extends Block {
  values: Array<f32> = new Array<f32>();
  downstream: Vector<F32PushStream> = new Array<F32PushStream>();

  constructor(blockId: u32, widths: Widths, ec: ExecutionContext) {
    super(blockId, widths, ec);
  }

  apply(downstream: Vector<F32PushStream>): Vector<F32PushStream> {
...
export class CosF32 extends Block implements F32PushStream {
  ...
  apply(downstream: Vector<F32PushStream>): CosF32 {
    this.downstream = downstream;
    return this;
  }
...
export class SinF32 extends Block implements F32PushStream {
  ...
  apply(downstream: Vector<F32PushStream>): SinF32 {
    this.downstream = downstream;
    return this;
  }
...
export class ConstF32 extends Block implements IntervalHandler, CloseHandler {
  precision: u32;
  v: f32;
  streams: Vector<F32PushStream> = new Array<F32PushStream>();
  timerId: u32 = 0;
  ...
  apply(streams: Vector<F32PushStream>): void {
